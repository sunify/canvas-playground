...
},{}],"1Xd6":[function(require,module,exports) {
...
},{}],"EY7r":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.distFast=o,exports.default=void 0;var t=e(require("victor"));function e(t){return t&&t.__esModule?t:{default:t}}function s(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function i(t,e){for(var s=0;s<e.length;s++){var i=e[s];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}function a(t,e,s){return e&&i(t.prototype,e),s&&i(t,s),t}function o(t,e,s,i){var a=s-t||.001,o=i-e||.001;return 1.426776695*Math.min(.7071067812*(Math.abs(a)+Math.abs(o)),Math.max(Math.abs(a),Math.abs(o)))}var n=function(){function e(i,a,o,n){s(this,e),this.pos=i,this.acc=o||new t.default(0,0),this.vel=a||new t.default(0,0),this.friction=n||new t.default(.7,.7)}return a(e,[{key:"update",value:function(t,e){this.vel.add(this.acc),this.vel.multiply(this.friction),this.pos.add(this.vel),this.pos.x>t&&(this.pos.x=0),this.pos.x<0&&(this.pos.x=t),this.pos.y>e&&(this.pos.y=0),this.pos.y<0&&(this.pos.y=e)}},{key:"applyToField",value:function(t,e){var s=Math.round(this.pos.x/e),i=Math.round(this.pos.y/e);if(t[s]&&t[s][i]){var a=t[s][i]*Math.PI;this.acc.setAxes(Math.sin(a)/40,Math.cos(a)/40)}}}]),e}();exports.default=n;
},{"victor":"1Xd6"}],"Sa0M":[function(require,module,exports) {
...
},{"./_MapCache":"ZmWn"}],"pRwI":[function(require,module,exports) {
"use strict";var e=u(require("run-with-fps")),t=i(require("./point")),n=u(require("victor")),r=u(require("@sunify/lerp-color")),a=u(require("eases")),o=u(require("lodash/memoize"));function i(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)if(Object.prototype.hasOwnProperty.call(e,n)){var r=Object.defineProperty&&Object.getOwnPropertyDescriptor?Object.getOwnPropertyDescriptor(e,n):{};r.get||r.set?Object.defineProperty(t,n,r):t[n]=e[n]}return t.default=e,t}function u(e){return e&&e.__esModule?e:{default:e}}function c(e,t){return h(e)||l(e,t)||d()}function d(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}function l(e,t){var n=[],r=!0,a=!1,o=void 0;try{for(var i,u=e[Symbol.iterator]();!(r=(i=u.next()).done)&&(n.push(i.value),!t||n.length!==t);r=!0);}catch(c){a=!0,o=c}finally{try{r||null==u.return||u.return()}finally{if(a)throw o}}return n}function h(e){if(Array.isArray(e))return e}var s=function(){var e=document.createElement("canvas").getContext("2d");return(window.devicePixelRatio||1)/(e.webkitBackingStorePixelRatio||e.mozBackingStorePixelRatio||e.msBackingStorePixelRatio||e.oBackingStorePixelRatio||e.backingStorePixelRatio||1)}(),f=window,v=f.innerWidth,m=f.innerHeight,p=function(e){return e*s},g=document.getElementById("bg"),w=g.getContext("2d");g.width=p(v),g.height=p(m),g.style.width=v+"px",g.style.height=m+"px";var M,y=function(e){w.beginPath(),e.forEach(function(e,t){var n=c(e,2),r=n[0],a=n[1];0===t?w.moveTo(r,a):w.lineTo(r,a)}),w.stroke()},P=[],b=function(){g.width=g.width;(P=P.filter(function(e){var t=c(e,2),n=(t[0],t[1]);return Date.now()-n<1300})).forEach(function(e){var t=c(e,2),n=t[0],o=t[1],i=(Date.now()-o)/1300;w.strokeStyle=(0,r.default)("rgba(255, 255, 120, 1)","rgba(255, 25, 0, 0.3)",a.default.quartInOut(i)),w.lineWidth=s,n.update();var u=Math.cos(n.vel.angle())*n.vel.length()*2/s,d=Math.sin(n.vel.angle())*n.vel.length()*2/s;w.beginPath(),w.moveTo(n.pos.x+u,n.pos.y+d),w.lineTo(n.pos.x,n.pos.y),w.stroke()})},x=function(e,r){if(k.length>1)for(var a=Math.atan2(k[1][1]-k[0][1],k[1][0]-k[0][0]),o=(0,t.distFast)(k[0][0],k[0][1],k[1][0],k[1][1]),i=0;i<15;i+=1){var u=a+Math.PI/1.7*(.5-Math.random()),c=Math.max(-40,o/3*-10)*Math.random();P.push([new t.default(new n.default(p(e),p(r)),new n.default(c*Math.cos(u),c*Math.sin(u)),new n.default(-.1*Math.cos(u),-.1*Math.sin(u))),Date.now()+100*Math.random(),u])}},E=!1,k=[],O=function(e){e.touches&&e.preventDefault(),!1===E&&(k=[]),k.push([e.pageX,e.pageY]),k=k.slice(-2),E=!0,M&&clearTimeout(M),x(e.pageX,e.pageY),M=setTimeout(function(){k=[],E=!1},400)};document.addEventListener("mousemove",O),document.addEventListener("touchforcechange",function(){},!1),document.addEventListener("touchmove",O,{passive:!1});var T=function(e,r){for(var a=0;a<40;a+=1){var o=2*Math.PI*Math.random(),i=30+120*Math.random()*s;P.push([new t.default(new n.default(e,r),new n.default(i*Math.cos(o),i*Math.sin(o)),new n.default(.7*Math.cos(o),.5)),Date.now()+1e3*Math.random(),o])}},q=function(e){if(e.altKey)for(var t=0;t<20;t++)setTimeout(function(){T(p(v)*Math.random(),p(m)*Math.random())},2e3*Math.random());else T(p(e.pageX),p(e.pageY))};document.addEventListener("mouseup",q),document.addEventListener("touchend",q);var D=(0,e.default)(b,20);module.hot&&module.hot.dispose(function(){D&&D()});
},{"run-with-fps":"VCqk","./point":"EY7r","victor":"1Xd6","@sunify/lerp-color":"8XB+","eases":"9uiP","lodash/memoize":"wFGW"}]},{},["pRwI"], null)
//# sourceMappingURL=/canvas-playground/sparks.9cac808f.map