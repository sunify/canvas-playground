...
"use strict";var e=u(require("run-with-fps")),t=i(require("./point")),n=u(require("victor")),a=u(require("@sunify/lerp-color")),r=u(require("eases")),o=u(require("lodash/memoize"));function i(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)if(Object.prototype.hasOwnProperty.call(e,n)){var a=Object.defineProperty&&Object.getOwnPropertyDescriptor?Object.getOwnPropertyDescriptor(e,n):{};a.get||a.set?Object.defineProperty(t,n,a):t[n]=e[n]}return t.default=e,t}function u(e){return e&&e.__esModule?e:{default:e}}function c(e,t){return s(e)||l(e,t)||d()}function d(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}function l(e,t){var n=[],a=!0,r=!1,o=void 0;try{for(var i,u=e[Symbol.iterator]();!(a=(i=u.next()).done)&&(n.push(i.value),!t||n.length!==t);a=!0);}catch(c){r=!0,o=c}finally{try{a||null==u.return||u.return()}finally{if(r)throw o}}return n}function s(e){if(Array.isArray(e))return e}var h=function(){var e=document.createElement("canvas").getContext("2d");return(window.devicePixelRatio||1)/(e.webkitBackingStorePixelRatio||e.mozBackingStorePixelRatio||e.msBackingStorePixelRatio||e.oBackingStorePixelRatio||e.backingStorePixelRatio||1)}(),f=window,v=f.innerWidth,m=f.innerHeight,p=function(e){return e*h},g=document.getElementById("bg"),w=g.getContext("2d");g.width=p(v),g.height=p(m),g.style.width=v+"px",g.style.height=m+"px";var M,y=function(e){w.beginPath(),e.forEach(function(e,t){var n=c(e,2),a=n[0],r=n[1];0===t?w.moveTo(a,r):w.lineTo(a,r)}),w.stroke()},P=[],b=function(){g.width=g.width;if((P=P.filter(function(e){var t=c(e,2),n=(t[0],t[1]);return Date.now()-n<1300})).forEach(function(e){var t=c(e,2),n=t[0],o=t[1],i=(Date.now()-o)/1300;w.strokeStyle=(0,a.default)("rgba(255, 255, 120, 0.7)","rgba(255, 25, 0, 0.3)",r.default.quartInOut(i)),w.lineWidth=h,n.update();var u=Math.cos(n.vel.angle())*n.vel.length()*2/h,d=Math.sin(n.vel.angle())*n.vel.length()*2/h;w.beginPath(),w.moveTo(n.pos.x+u,n.pos.y+d),w.lineTo(n.pos.x,n.pos.y),w.stroke()}),!E){var e=Date.now()/3e3,t=v/2+200*Math.cos(e),n=m/2+300*Math.sin(e)*(Math.cos(e)/2);k.push([t,n]),k=k.slice(-2),x(t,n)}},x=function(e,a){if(k.length>1)for(var r=Math.atan2(k[1][1]-k[0][1],k[1][0]-k[0][0]),o=(0,t.distFast)(k[0][0],k[0][1],k[1][0],k[1][1]),i=0;i<15;i+=1){var u=r+Math.PI/1.7*(.5-Math.random()),c=Math.max(-40,o/3*-10)*Math.random();P.push([new t.default(new n.default(p(e),p(a)),new n.default(c*Math.cos(u),c*Math.sin(u)),new n.default(-.1*Math.cos(u),-.1*Math.sin(u))),Date.now()+100*Math.random(),u])}},E=!1,k=[],O=function(e){e.touches&&e.preventDefault(),!1===E&&(k=[]),k.push([e.pageX,e.pageY]),k=k.slice(-2),E=!0,M&&clearTimeout(M),x(e.pageX,e.pageY),M=setTimeout(function(){k=[],E=!1},400)};document.addEventListener("mousemove",O),document.addEventListener("touchforcechange",function(){},!1),document.addEventListener("touchmove",O,{passive:!1});var D=function(e,a){for(var r=0;r<40;r+=1){var o=2*Math.PI*Math.random(),i=30+120*Math.random()*h;P.push([new t.default(new n.default(e,a),new n.default(i*Math.cos(o),i*Math.sin(o)),new n.default(.7*Math.cos(o),.5)),Date.now()+1e3*Math.random(),o])}},T=function(e){if(e.altKey)for(var t=0;t<20;t++)setTimeout(function(){D(p(v)*Math.random(),p(m)*Math.random())},2e3*Math.random());else D(p(e.pageX),p(e.pageY))};document.addEventListener("mouseup",T),document.addEventListener("touchend",T);var q=(0,e.default)(b,20);module.hot&&module.hot.dispose(function(){q&&q()});
},{"run-with-fps":"VCqk","./point":"EY7r","victor":"1Xd6","@sunify/lerp-color":"8XB+","eases":"9uiP","lodash/memoize":"wFGW"}]},{},["pRwI"], null)
//# sourceMappingURL=/canvas-playground/sparks.81b10954.map